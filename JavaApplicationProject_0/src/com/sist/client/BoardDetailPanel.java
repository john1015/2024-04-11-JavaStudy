...
public class BoardDetailPanel extends JPanel implements ActionListener {
	...
	public BoardDetailPanel(ControlPanelEmp cp) {
		this.cp = cp;
		...
		noLa.setOpaque(true);
		noLa.setBackground(new Color(75, 255, 210));
		...
		dayLa.setBackground(new Color(75, 255, 210));
		...
		nameLa.setBackground(new Color(75, 255, 210));
		...
		hitLa.setBackground(new Color(75, 255, 210));
		...
		subLa.setBackground(new Color(75, 255, 210));
		sub = new JLabel("");
	...
	public BoardDetailPanel(ControlPanel cp2) {
		this.cp2 = cp2;
		dao = BoardDAO.newInstance();
