...
public class ZipcodeDAO {
	...
	/*
	 * 	localhost => 본인 컴퓨터 => IP
	 * 	1521 : port , 1433(MSSQL) , 3306(MYSQL , MariaDB)
	 * 	XE : table이 저장된 데이터베이스 => ORCL/ORA
	 * -------- 연습용 => 무료
	 */
	...
	public ArrayList<ZipcodeVO> postFind(String dong){
		...
		try {
			...
			// 메모리 => 커서의 위치 마지막에 존재 => 첫째줄에 이동 => next()
			while(rs.next()) {
