 ...
 * 																 => 상세보기
 * 				   데이터 활용 : 메소드를 여러개 묶어서 관리 => Manager(사용자가 요청시 => 처리)
 * 							   액션 클래스 (동작을 정의)
 * 				   데이터+메소드 => 혼합
 * 				   ----------------------- 벤치마킹 = 요구사항
 * 		   클래스 설계 내용
 ...
 * 												예) int a; a=100; ===> int a=100;
 * 						{
 * 							a=100; => 구현
 * 						}
 * 					}
 * 				= 정적 변수 초기화 블록 ===> static변수는 초기화 블록에서 주로 사용
 * 					class A{
 * 						static int a=100;
 * 						static{
...
class Student{
	...
	public Student(String s , int a) {
		this("박문수",s,a); // (String n , String s , int a)
	}
...
public class 클래스_114 {
	...
	public static void main(String[] args) {
		/*
		 * Student s1 = new Student(); s1.print();
		 * 
		 * System.out.println("========= 사용자 입력 받아서 초기화 =========="); Student s2 = new
		 * Student("심청이","여자",20); s2.print();
		 */
		/*
		 * Student s1 = new Student("박문수"); s1.print(); Student s2 = new
		 * Student("여자",30); s2.print();
		 */
		//Member m1 = new Member("d");
		Sawon s = new Sawon();
