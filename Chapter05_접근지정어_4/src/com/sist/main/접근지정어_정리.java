 ...
 * 
 * 2. 사용범위를 지정 : 접근지정어
 * 	  private : 자신의 클래스 내에서 접근이 가능 => 데이터를 감출때(은닉화)
 ...
 *   => 패키지를 불러오는 방법
 *   	import com.회사명.dao.*; => dao폴더 안에있는 모든 클래스를 불러온다
 ...
 *    	
 *    	   Date date = new Date(); => 오류 발생 둘중하나 *를 Date로하면 그걸사용
 *    --------------------------------------------------------------------
 *    변수 		연산자 		제어문
 *    			-----------------
 *    				   |
