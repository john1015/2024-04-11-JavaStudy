 ...
 *  	예) print(int) print(char) pirnt(char[]) ...
 *  	   --------------------------------------
 *  	 	printInt() printChar ...
 *  
 *  	=> 사칙연산
 ...
 *										public void getName() - 이름 대문자
 *													   -	
 *										public void isLogin() - boolean형은 get이아니라 is
 *													  -	
 *								   }
 *								   class B{
 *										A a = new A();
 ...
 *					=> this가 없다
 *				인스턴스 메소드 : 인스턴스 메소드 , 인스턴스 변수 , static변수 , static메소드 사용이 가능
 *				---------------------- this가 있다
 * 				
 * 
 */
...
class DGB{
	...
	/*
	 * public static void aaa() { // 클래스의 멤버변수가 아니다 => 공통 사용부분을 구사
	 * System.out.println(age);
	 * 
	 * }
	 */
	// 우클릭 - Source - Generate Getters and Setters클릭 
	public String getName() {
		return name;
	}
	public void setName(String n) {// 변수명이 다르면(충돌이 안되면) this생략 가능(this.name)
		name = n;
		// 지역변수 우선순위
		// 지역변수 , 매개변수 ===> 멤버변수
 	}
