 ...
 *    에러발생
 *    -------- 1. 처리 (조건문 = 고려) => 조건문으로 처리가 어려운경우 => 예외처리 이용
 ...
 *                            		= StringTokenizer , Calender , Date , Scanner
 *                            			*** List / Set / Map => 컬렉션
 ...
 *                   }
 *                   
 *                   => 라이브러리 => 이미 소스 코딩이 되어 있는 상태 => try ~ catch 보다 throws가 편리하다
 *                   															------ 유지보수
 *    
 */
public class 예외처리_1 {
	// display() 호출시에 => 이런 에러가 발생 할 수 있다 (예상)
