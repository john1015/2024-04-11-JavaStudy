 ...
 *           송신/수신 => 1byte => 자바에는 각국의 언어를 사용할 수 있게 2byte를 사용할 수 있게 제작
 *           -----------------
 *           1byte => 바이트 스트림
 ...
 *           	InputStream        OutputStream
 *           		|					|
 *           	FileInpitStream		FileOutputStream
 ...
 *                 
 *                 -------------------- 필터스트림 --------------------------------
 *                 파일에 있는 데이터를 메모리 한번에 이동후에 사용이 가능 => 속도가 빠르다 Buffered~
