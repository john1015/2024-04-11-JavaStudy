 ...
 * }				
 * ------------------------------------------------------------------------------------------------------------
 * 정적변수(static)				컴파일시에 메모리에 저장		    자신의 클래스전체    	프로그램 종료시		  Method Area
 * class A{						접근방식 : 클래스명.변수명	    => 다른 클래스
 * 								new없이 저장이 가능
 ...
 * 		메모리 할당				 메모리 해제
 * 	 ==> new					delete
 * 	 ==> 프로그래머가 삭제 소홀 : 프로그램을 종료 하면 자동으로 운영체제에서 삭제
 * 	 ==> 변수가 많아지면서 문제 발생 => 가비지 컬렉션(자동 메모리 회수)
 * 								------------
 * 								=> 회수할때 프로그램 종료시쯤 회수
 * 								=> 멀티미디어 => 직접 회수 : System.gc()
 * ------------------------------------------------------------------------------------------------------------
 * 지역변수					메소드 호출시마다 메모리 생성 		메소드 안에서만 사용		메소드가 종료(return)		  Stack
...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// 저장이 된 상태 => 컴파일시에 메모리에 저장 => Method Area
