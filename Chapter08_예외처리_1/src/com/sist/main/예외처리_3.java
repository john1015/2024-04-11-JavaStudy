 ...
 *                                       		try ~ catch
 *                                       		---   -----
 *                                            소스코딩  에러발생시 처리 => 예상되는 에러를 처리하기 때문에 여러개 사용이 가능
 *                                       ------------------------ 가장많이 사용된다 -------------------------
 *                                       
...
public class 예외처리_3 {
	...
	public static void main(String[] args) {
		...
		// num1 , num2 , num3안에서만 사용 n1,n2,n3
		...
		// 정상 수행 가능 , 사용자가 입력을 잘못한 경우 => 에러 처리가 안된다 => 입력값을 받아야 알 수 있다
		// => 강제로 예외처리를 하지 않는다 => 필요시 => 예외처리를 생략 가능
