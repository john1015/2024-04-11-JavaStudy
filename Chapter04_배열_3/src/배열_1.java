 ...
 * 				arr=[I@6f2b958e → 주소
 * 								  연속적인 메모리를 가지고 있다
 * 								 arr[0] arr[1] arr[2]arr[3]arr[4] → 인덱스를 이용 → 실제하는 일반변수 사용과 동일
 * 				arr ---------->  ------------------------------
 * 								 0	 |   0	|   0	|  0  |  0	 
 * 								 |------------------------------ 같은 크기의 메모리가 5개 생성
 * 								[I@6f2b958e 
 ...
 * 								 7. 나이
 * 								 -------
 * 								 변수 →  3명 → 7명 ... 제어하기가 힘들다 → 배열 → 다른 데이터형도 많아지면 힘들다 → 클래스
 * 										String name; → String name=new name[3];
 * 										String sex;     	...
 * 										int hakbun;			...
 * 										int year;			...
 * 										String address;
 ...
 * 								   10  |  20  |  30  |  40  |  50
 * 								|-----------------------------------
 * 							0x1000	 0x104   0x108  0x112  0x116
...
public class 배열_1 {
	...
	public static void main(String[] args) {
		...
		//int[] arr1=new int[5];
		//System.out.println(arr1); // 실제 주소
		
		/*
		 * int[] arr = {10,20,30,40,50}; int[] temp=arr; temp[0]=100; temp[1]=200; //
		 * arr[0]=100 , arr[1]=200; System.out.println(Arrays.toString(arr));
		...
		// 설정된 그래도 복사 → 새로운 배열을 생성 → clone → 깊은 복사
