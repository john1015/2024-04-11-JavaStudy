 ...
 *       		  = 비정형와 데이터 => 구분이없는 데이터 (트위터 , facebook)
 *       			-----------> 정형화(빅데이터) => 통계 , 분석
 ...
 *       		 0132456789
 *       			   ---- 6
 *       		public String subString(int start , int end) => end는 포함 X
 *       		"Hello Java"
 *       		   ---
 *       		 0123456789
 *       		   ---
