...
public class MainClass {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 	메소드
		 * 		=> 구현된 메소드 : 상속받는 클래스의 구현 내용이 동일
		 * 			=> [접근지정어] 리턴형 메소드명(매개변수 ..){
		 * 					구현하는 내용이 들어간다
		 * 				}
		 * 		=> 구현안된 메소드 : 상속받는 클래스가 동일하지 않는 경우에 선언 => abstract
		 ...
		 * 
		 * 		}
		 * 		구현이 안된 메소드가 없는 경우는 추상클래스 보다 일반클래스가 편하다 
		 * 		------------------------------------------------------------
		 * 		| 자체 메모리 할당이 가능
		 * 		| 추상클래스는 무조건 상속을 내려서 처리 => 클래스 여러개 동시에 제어하고 싶다 ...
		 * 			
		 */
