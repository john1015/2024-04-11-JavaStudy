...
class Sawon{
	 ...
	 * 
	 * ** 객체지향 프로그램은 
	 * 		여러개의 데이터 + 여러개의 메소드를 한곳에 저장한 루에 동시에 제어
	 * 		-------------------------- 저장 공간을 객체
	 * 											---- 한번에 기능을 만들어서 사용
	 * 											1. 재사용
	 * 											----------
	 ...
	 *  									   ----------------------------- 객체 지향
	 *   | 스투덥 => 몸값을 올리기 위해 일부로 어려운 언어를 만듬
	 *     1980년도 IBM => C언어 개발자 양성
	 *   ------------------------------------------------------------------------------
	 *   2001년도 ~ 2024년도 자바개발자 양성
	 *                     ------------
	 *                      공급 > 수요 => 자바는 가치가 많이 하락
	 *                      => 최신에 가장 많이 사용하는 기술
	 *                         ------------------------
...
public class 클래스_4 {
	...
	public static void main(String[] args) {
		Sawon hong = new Sawon();// 저장 => 메모리공간 (sabun ,name ,dept,job,olc,pay)
