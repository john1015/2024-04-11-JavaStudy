 ...
 *  A a= new A();
 *  ----- a ------
 *  0x200 ==> 0x200번에 있는 name이라는 변숙값을 읽어 온다 => a.name
 *  --------------- => 0x200 -----------------
 *  						  ---- name ------
 *  							null
 *  						  -----------------	
...
public class 클래스_9 {
	...
	public static void main(String[] args) {
		...
		/*
		 * int a=10; int b=a; b=100; System.out.println("a = "+a);
		...
		//메모리 주소를 받는 경우 => 메모리에 있는 변수 자체를 제어할 수 있다 => a 의 별칭 => 동시에 같은 메모리 변수를 사용할수있게 만든다
		A b=a;
		System.out.println("b= "+b);
		a.name="이순신";
		a.age=25;
