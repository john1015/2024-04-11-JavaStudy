...
public class 예외처리_응용 extends JFrame implements ActionListener{
	...
	int com;// 난수
	int user;// 사용자 입력값
	// 메소드 2개이상에 사용 => 멤버변수 => 1. 입력값을 받을때 2. 비교시에 사용
	// 메소드 한개에서만 사용 => 지역변수
	...
	public void compare() {
		if(com>user) {
			...
			int no = JOptionPane.showConfirmDialog(this,"종료", "종료할까요??", JOptionPane.YES_NO_OPTION);
	...
	// 예외처리는 에러가 발생시 종료하는 목적이 아니라 => 프로그램을 정상상태로 유지하는 목적을 지키고 있다
